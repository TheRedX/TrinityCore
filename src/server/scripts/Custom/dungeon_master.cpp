...
#define ARE_YOU_SURE	"|cffffffffOk Brave Warrior, Let's go to|r "
...
class dungeon_script_mortal : public CreatureScript
{
	public:
	dungeon_script_mortal()
	: CreatureScript("dungeon_script_mortal")
	{
	}
